...
foreach ($row in $data) {
  ...
  switch ($service) {
      ...
      "Relation Medias" { $row.Groupe_Service = "GRP_CRP_RM" }
      ...
      "Developpement et Intégration" { $row.Groupe_Service = "GRP_DSI_DI" }
      "Service Comptabilité" { $row.Groupe_Service = "GRP_FC_COM" }
      "Finance" { $row.Groupe_Service = "GRP_FC_FIN" }
      "Fiscalite" { $row.Groupe_Service = "GRP_FC_FIS" }
  ...
  foreach ($row in $data) {
    ...
    switch ($service) {
        ...
        "Relation Medias" { $row.SousOU = "Relations-Medias" }
        ...
        "Developpement et Intégration" { $row.SousOU = "Developpement-Integration" }
        "Service Comptabilité" { $row.SousOU = "Comptabilite" }
        "Finance" { $row.SousOU = "Finance" }
        "Fiscalite" { $row.SousOU = "Fiscalite" }
